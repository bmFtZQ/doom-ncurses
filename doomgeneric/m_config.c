...
//  * DG_KEY_PAUSE is wrong - it's in the DG_KEY_NUMLOCK spot. This shouldn't
...
static const int scantokey[128] =
{
    ...
    'b',    'n',    'm',    ',',    '.',    '/',    DG_KEY_RSHIFT,DG_KEYP_MULTIPLY,
    DG_KEY_RALT,  ' ',  DG_KEY_CAPSLOCK,DG_KEY_F1,  DG_KEY_F2,   DG_KEY_F3,   DG_KEY_F4,   DG_KEY_F5,
    DG_KEY_F6,   DG_KEY_F7,   DG_KEY_F8,   DG_KEY_F9,   DG_KEY_F10,  /*DG_KEY_NUMLOCK?*/DG_KEY_PAUSE,DG_KEY_SCRLCK,DG_KEY_HOME,
    DG_KEY_UPARROW,DG_KEY_PGUP,DG_KEY_MINUS,DG_KEY_LEFTARROW,DG_KEYP_5,DG_KEY_RIGHTARROW,DG_KEYP_PLUS,DG_KEY_END,
